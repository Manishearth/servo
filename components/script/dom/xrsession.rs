...
impl XRSession {
        ...
        ROUTER.add_route(
            ...
            Box::new(move |message| {
                ...
                #[cfg(feature = "xr-profile")]
                {
                    ...
                    println!("WEBXR PROFILING [raf receive]:\t{}ms", (received - frame.sent_time) as f64 / 1_000_000.);
    ...
    fn raf_callback(&self, mut frame: Frame) {
        ...
        #[cfg(feature = "xr-profile")]
        println!("WEBXR PROFILING [raf queued]:\t{}ms", (raf_start - frame.sent_time) as f64 / 1_000_000.);
        ...
        #[cfg(feature = "xr-profile")]
        println!("WEBXR PROFILING [raf execute]:\t{}ms", (time::precise_time_ns() - raf_start) as f64 / 1_000_000.); 
